...
export abstract class ReverseGeocodingServiceModel {
    abstract getAddressByCoordinates(coordinate: Coordinates): Promise<string>;
}

@Injectable({
    providedIn: 'root',
})
export class ReverseGeocodingServiceMock extends ReverseGeocodingServiceModel {
    override async getAddressByCoordinates(
