...
import { provideLoginPageMockService, updateGetVMSignal } from './login-page.service.mock';
...
describe('LoginPageComponent', () => {
  ...
  it('should disable the submit button if the loginForm is invalid', () => {
    ...
    //Assert
    const button = fixture.nativeElement.querySelector('form button[type="submit"]');
